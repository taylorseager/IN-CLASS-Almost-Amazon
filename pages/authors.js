  ...
  array.forEach((item) => {
    ...
    <div class="card" style="width: 18rem;">
      <div class="card-body">
        ...
        <hr>
          <p class="card-text>${item.favorite ? `<span class="badge badge-info fave-badge"><i class="fa-solid fa-heart" aria-hidden="true"></i></span> ${item.favorite}` : `${item.favorite}`}</p>
